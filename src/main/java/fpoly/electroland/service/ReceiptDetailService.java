...
public class ReceiptDetailService {
    ...
    public Double getRevenuePercentChange(LocalDateTime endDate) {
        ...
        Long revenueCurrentMonth = receiptDetailRepository.getRevenueByDateRange(startDateCurrentMonth, endDateCurrentMonth);
        Long revenuePreviousMonth = receiptDetailRepository.getRevenueByDateRange(startDatePreviousMonth, endDatePreviousMonth);
    ...
    public Double getSuccessfulOrdersPercentChange(LocalDateTime endDate) {
        ...
        Long successfulOrdersCurrentMonth = receiptDetailRepository.getSuccessfulOrders(startDateCurrentMonth, endDateCurrentMonth);
        Long successfulOrdersPreviousMonth = receiptDetailRepository.getSuccessfulOrders(startDatePreviousMonth, endDatePreviousMonth);
    ...
    public Double getFailedOrdersPercentChange(LocalDateTime endDate) {
        ...
        Long failedOrdersCurrentMonth = receiptDetailRepository.getFailedOrders(startDateCurrentMonth, endDateCurrentMonth);
        System.out.println("failedOrdersCurrentMonth: " + failedOrdersCurrentMonth);
        
        Long failedOrdersPreviousMonth = receiptDetailRepository.getFailedOrders(startDatePreviousMonth, endDatePreviousMonth);
    ...
    public Double getCustomerCountPercentChange(LocalDateTime endDate) {
        ...
        Long customerCountCurrentMonth = receiptDetailRepository.getCustomerCount(startDateCurrentMonth, endDateCurrentMonth);
        Long customerCountPreviousMonth = receiptDetailRepository.getCustomerCount(startDatePreviousMonth, endDatePreviousMonth);
